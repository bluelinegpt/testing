...
describe("public technical SEO endpoints", () => {
  it("renders English, Arabic and x-default sitemap alternates with localized lastmod",()=>{
    const xml=renderLocalizedSitemap("https://tawseelhub.com",[{path:"/ar/blog/مقال",lastmod:"2026-09-05T00:00:00.000Z",alternates:[{locale:"en",path:"/blog/article"},{locale:"ar",path:"/ar/blog/مقال"}],xDefault:"/blog/article"}]);
  ...
  it("serves the database-backed sitemap as XML", async () => {
    const xml="<?xml version=\"1.0\"?><urlset xmlns:xhtml=\"http://www.w3.org/1999/xhtml\"><url><loc>https://tawseelhub.com/ar/blog/مقال</loc><xhtml:link rel=\"alternate\" hreflang=\"en\" href=\"https://tawseelhub.com/blog/article\" /></url></urlset>";
