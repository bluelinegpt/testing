...
export class CreateCustomerQuoteDto {
  ...
  @Transform(clean) @IsString() @MinLength(4) @MaxLength(500) pickupAddress!: string;
  ...
  @Transform(clean) @IsString() @MinLength(4) @MaxLength(500) deliveryAddress!: string;
  @Transform(clean) @IsString() @MinLength(2) @MaxLength(160) recipientName!: string; @Transform(normalizePhone) @Matches(phone) recipientMobile!: string;
  ...
  @IsIn(packages) packageType!: string; @Transform(clean) @IsString() @MinLength(2) @MaxLength(500) description!: string;
  @Type(()=>Number) @IsNumber({maxDecimalPlaces:3}) @Min(0.01) @Max(10000) weightKg!: number;
  @Type(()=>Number) @IsNumber({maxDecimalPlaces:2}) @Min(0.01) @Max(10000) lengthCm!: number;
  @Type(()=>Number) @IsNumber({maxDecimalPlaces:2}) @Min(0.01) @Max(10000) widthCm!: number;
  @Type(()=>Number) @IsNumber({maxDecimalPlaces:2}) @Min(0.01) @Max(10000) heightCm!: number;
