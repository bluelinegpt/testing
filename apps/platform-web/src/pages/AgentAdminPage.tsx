      ...
      {tab === "settings" && settings ? (
        <div className="platform-grid platform-grid--two">
          <form className="platform-card platform-form" onSubmit={saveSettings}>
            ...
            <label><input type="checkbox" checked={settings.humanHandoffEnabled} onChange={(event) => setSettings({ ...settings, humanHandoffEnabled: event.target.checked })} /> Human Handoff Enabled</label>
