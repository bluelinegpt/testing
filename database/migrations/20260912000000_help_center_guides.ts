...
export async function up(db: Kysely<unknown>): Promise<void> {
  ...
  await sql`
    ...
    from (values
      ...
      ('what-is-tawseelhub','ar','ما هو Tawseelhub؟','Tawseelhub نظام تشغيل لشركات التوصيل في الإمارات يساعد في الطلبات والسائقين والتحصيل والتقارير.','[{"type":"paragraph","text":"يساعد Tawseelhub شركات التوصيل على إدارة الطلبات والسائقين وتحصيل مبالغ الدفع عند الاستلام وتسويات التجار والتقارير من نظام واحد."},{"type":"paragraph","text":"للبداية اختر إرسال شحنة، تسجيل تاجر، أو طلب عرض توضيحي لشركة توصيل."}]','getting-started','all','published',true,true,10,'ما هو Tawseelhub؟ | مركز المساعدة','تعرف على Tawseelhub وكيف يساعد شركات التوصيل والتجار والعملاء في الإمارات.')
